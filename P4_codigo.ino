...
#define TOKEN "BBFF-GRlQtci7WKymF0Uua7zmj6BHEcTpon" // Ubidots TOKEN name el mismo que usamos en clase
#define MQTT_CLIENT_NAME "12as12sd" //ID del cliente, 8 a 12 chars alfanumericos (ASCII), debe ser random y unico dif a otros devices
#define VARIABLE_LABEL_temp "temperatura" // Variable Temperatura
#define VARIABLE_LABEL_hum "humedad" // Variable Humedad
#define DEVICE_LABEL "Lector-tempertaura-humedad" // Nombre del dispositivo a crear
